        ...
        <div className="text-gray-700 text-base mb-4">
           ...
           <h4>Importe Total: $ {p.cantidad * p.precioPorPersona} </h4>
            ...
            <div className="bg-green-50 font-light text-xl pb-2 decoration-8">
                ...
                <button className="mt-3 mb-3 ml-1 bg-green-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline " onClick={(()=>clearCart())} >Vaciar Carrito</button>                 
            </div>
          </>
    )
}
